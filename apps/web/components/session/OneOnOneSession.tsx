            ...
            <main className="flex-1 w-full max-w-[1400px] mx-auto p-4 md:p-6 lg:p-8 flex gap-6 lg:gap-8 overflow-hidden" style={{ height: "calc(100vh - 66px)" }}>
                ...
                <section className="flex-1 flex flex-col h-full gap-0 max-w-[860px] mx-auto w-full">
                    ...
                    >
                        ...
                        {isPendingNext && (
                            <div className="flex gap-4">
                                <div className="flex-shrink-0 mt-1">
                                    <div className="size-9 rounded-xl bg-gray-800 flex items-center justify-center">
                                        <Bot className="text-gray-600" size={17} />
                                    </div>
                                </div>
                    ...
                    <div className="shrink-0 pt-4">
                        <div className="bg-gray-900 border border-gray-700 rounded-2xl shadow-2xl ring-1 ring-transparent focus-within:ring-primary/40 focus-within:border-primary/50 transition-all duration-200">
                            <textarea
                            ...
                            <div className="flex items-center justify-between px-4 pb-3 pt-2 border-t border-gray-800">
                                <div className="flex items-center gap-1 text-gray-600">
                                    ...
                                    <span className={`text-[10px] font-mono tabular-nums transition-colors ${answerText.length > 1800 ? "text-red-400" : "text-gray-600"}`}>
                                ...
                                <div className="flex items-center gap-3">
                                    <span className="hidden sm:block text-[10px] text-gray-700">
                                     ...
                                     <button
                                         ...
                                         disabled={!canSubmit}
                                         className="bg-primary hover:bg-violet-600 disabled:bg-gray-800 disabled:text-gray-600 text-white px-5 py-2 rounded-xl text-sm font-semibold shadow-lg shadow-primary/30 transition-all active:scale-95 flex items-center gap-2 group"
                                     >
                                        {submitResponse.isPending || isPendingNext || questions.length === 0 ? (
