...
export function StatCard({
    ...
    return (
        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between gap-4 hover:shadow-premium transition-all group">
            <div className="flex justify-between items-start">
                ...
                <span className={cn(
                    ...
                    isPositive ? "text-primary bg-primary/5 border-primary/10" :
                        isNeutral ? "text-gray-500 bg-gray-50 border-gray-100" :
            ...
            <div>
                ...
                <div className="flex items-end gap-1">
                    ...
                    {unit && <span className="text-sm text-gray-400 font-medium mb-1">{unit}</span>}
                </div>
            </div>
        </div>
    );
