...
"[project]/apps/web/app/(auth)/login/email-otp/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function EmailOtpRequestPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$api$2f$identity$2e$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["identityApi"].requestOtp(email);
            if (response.success) {
...
_s(EmailOtpRequestPage, "MZrKp41KwYeog240wCI4MMG8zlQ=", false, function() {
    return [
...
_c = EmailOtpRequestPage;
var _c;
__turbopack_context__.k.register(_c, "EmailOtpRequestPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=apps_web_79671376._.js.map