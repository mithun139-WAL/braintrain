...
export default function LoginPage() {
    ...
    const handleGoogleLogin = async () => {
        setError(null);
        try {
            // In a real scenario, this would be the token from the Google One Tap/Login SDK
            ...
            <div className="p-8 sm:p-10">
                ...
                <form className="space-y-5" onSubmit={handleSubmit}>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <button
                            className="flex items-center justify-center px-4 py-2.5 border border-slate-300 dark:border-slate-700 rounded-lg shadow-sm bg-white dark:bg-slate-800 text-sm font-medium text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-200 transition-colors disabled:opacity-50"
                            type="button"
