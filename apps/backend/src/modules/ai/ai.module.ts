...
import { AI_EVALUATION_PROVIDER, AI_QUESTION_GENERATION_PROVIDER } from './ai.tokens';
 ...
 *   OPENAI_API_KEY set   → OpenAI providers (GPT-4o)
...
aiLogger.log(`AI Providers: ${useOpenAI ? 'OpenAI (GPT-4o)' : 'Stub (offline)'}`);
...
@Module({
    ...
    exports: [AI_EVALUATION_PROVIDER, AI_QUESTION_GENERATION_PROVIDER],
})
